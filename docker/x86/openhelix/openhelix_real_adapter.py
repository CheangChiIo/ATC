...
OPENHELIX_REPO = Path(os.environ.get("OPENHELIX_REPO", "/repos/openhelix_repo_check"))
DEFAULT_OPENHELIX_ROOT = Path("/checkpoints/openhelix/prompt_tuning_aux")
DEFAULT_CLIP_ROOT = Path("/checkpoints/openhelix/clip-vit-large-patch14")
...
class OpenHelixRealAdapter:
    def __init__(
        ...
        self.system1_denoising_steps = 25
        self.model_info = {
            ...
            "vision_tower": str(self.vision_tower),
            # Matches DiffuserActorACTS(diffusion_timesteps=25) above.
            "denoising_steps": int(self.system1_denoising_steps),
            "system1_denoising_steps": int(self.system1_denoising_steps),
            "system2_denoising_steps": 0,
            "system2_step_semantics": "single LLaVA/LISA forward to final-layer <ACT> hidden embedding; no iterative denoising in System-2.",
