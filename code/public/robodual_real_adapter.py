...
ROBODUAL_REPO = Path(os.environ.get("ROBODUAL_REPO", "/home/dell/桌面/Robodual_AGX_v4_Asyn_nvtx_bandwidth/RoboDual_AGX"))
DEFAULT_GENERALIST = Path("/home/dell/ATC/checkpoints/robodual-openvla-generalist")
